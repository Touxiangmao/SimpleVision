...
namespace ViewROI
{
    ...
    /// defined in ROI.cs.
    /// </summary>
    public class ROIRectangle2 : ROI, RoiInterfac
    {
        ...
        public ROIRectangle2(string Name)
        {
            RoiName = Name;
            RoiType = GetType().ToString();
            NumHandles = 6; // 4 corners +  1 midpoint + 1 rotationpoint			
        ...
        public override void createROI(HTuple RoiParameters)
        {
            ...
            phi = RoiParameters[2];
            length1 = RoiParameters[3];
            length2 = RoiParameters[4];
        ...
        {
            return new HTuple(new string[] { "中心行", "中心列", "角度", "边长1", "边长2" });
        }
        /// <summary> 
